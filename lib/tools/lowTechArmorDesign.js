class ArmorBuilder {
    constructor(size = 0, { use_weight_scaling = false, use_sm_scaling = true }, weight, customMaterials, customConstructions) {
        this.size = size;
    ...
    get weight() {
        ...
        if (this.weight && this.use_weight_scaling) {
            ...
            console.log("yupeee");
            return Object.values(SizeMultipliers)[this.size + 6] * final;
        }
    }
    get cost() {
...
(function (SizeMultipliers) {
    SizeMultipliers[SizeMultipliers["sm_less_6"] = 0.1] = "sm_less_6";
    SizeMultipliers[SizeMultipliers["sm_less_5"] = 0.04] = "sm_less_5";
    SizeMultipliers[SizeMultipliers["sm_less_4"] = 0.09] = "sm_less_4";
    SizeMultipliers[SizeMultipliers["sm_less_3"] = 0.16] = "sm_less_3";
    SizeMultipliers[SizeMultipliers["sm_less_2"] = 0.25] = "sm_less_2";
    SizeMultipliers[SizeMultipliers["sm_less_1"] = 0.64] = "sm_less_1";
    SizeMultipliers[SizeMultipliers["sm_0"] = 1] = "sm_0";
    SizeMultipliers[SizeMultipliers["sm_1"] = 2.25] = "sm_1";
    SizeMultipliers[SizeMultipliers["sm_2"] = 6.25] = "sm_2";
    SizeMultipliers[SizeMultipliers["sm_3"] = 12.25] = "sm_3";
    SizeMultipliers[SizeMultipliers["sm_4"] = 25] = "sm_4";
    SizeMultipliers[SizeMultipliers["sm_5"] = 56.25] = "sm_5";
    SizeMultipliers[SizeMultipliers["sm_6"] = 100] = "sm_6";
...
(function (ConstructionTypes) {
    ConstructionTypes["fabric"] = "fabric";
    ConstructionTypes["layered_fabric"] = "layered_fabric";
    ConstructionTypes["scale"] = "scale";
    ConstructionTypes["mail"] = "mail";
    ConstructionTypes["segmented_plate"] = "segmented plate";
    ConstructionTypes["plate"] = "plate";
    ConstructionTypes["solid"] = "solid";
...
//# sourceMappingURL=lowTechArmorDesign.js.map