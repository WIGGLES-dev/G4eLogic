<script lang="ts">
    ...
    function createTooltips() {
        draw.find(`[data-location-group]`).forEach((svg) => {
            ...
            tooltips[location ? location.location : ""] = tooltip(svg.node, {
    ...
    $: getLocations = () => {
        ...
        const allSilhoueteLocations = [...left, ...right].reduce(
        ...
        return {
            ...
            other: [...Object.values($hitLocations$)].filter(
                (location) => !allSilhoueteLocations.includes(location.location)
            ),
        };
    };
</script>
...
<style>
    ...
    svg [data-location-group] {
        @apply transition-opacity duration-300;
    }
    svg [data-location-group]:not(.focused):hover,
    svg [data-location-group].focused [data-location]:hover {
        fill: #4a5568;
        stroke: #4a5568;
    }

    svg [data-location-group].crippled,
    svg [data-location].crippled {
        fill: red;
        stroke: #4a5568;
    }

    svg [data-location-group]:not(.focused) [data-location="vitals"] {
    }
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="damage-input"
                                placeholder="0"
                                bind:value={$character.hitLocationDamage[location.location]} />
                            <input
                        ...
                        <div class="h-2">
                            <Bar
                                ...
                                current={$character.hitLocationDamage[location.location]} />
                        </div>
                    </div>
                {/each}
            </div>
