...
<Tabs>
  ...
  <TabPanel>
    <DataTable type="trait modifier" maxDepth="{1}" rootId="{$entity.id}" />
  </TabPanel>
  <TabPanel>
    <DataTable type="melee weapon" maxDepth="{1}" rootId="{$entity.id}" />
  </TabPanel>
  <TabPanel>
    <DataTable type="ranged weapon" maxDepth="{1}" rootId="{$entity.id}" />
  </TabPanel>
  <TabPanel>
