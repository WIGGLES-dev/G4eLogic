<script lang="ts">
    ...
    $: getLocations = () => {
        const allSilhoueteLocations = [
            ...leftLocations,
            ...rightLocations,
        ].reduce((silhoueteLocations, location) => {
            return [
                ...silhoueteLocations,
                location,
    ...
    <section class="relative w-min">
        <div class="flex">
            ...
            <svg
                ...
                </style><g on:click={focusLocation} data-location-group="torso">
                    <path
                        data-location="chest"
...
<style lang="postcss">
    ...
    svg :global([data-location-group].crippled),
    svg :global([data-location].crippled) {
        fill: red;
        stroke: #4a5568;
    }
